function(generate_convex MESH_INPUT_FOLDER CONVEX_OUTPUT_FOLDER)
  file(GLOB_RECURSE MESH_FILES ${MESH_INPUT_FOLDER}/*.obj
       ${MESH_INPUT_FOLDER}/*.ply ${MESH_INPUT_FOLDER}/*.stl
       ${MESH_INPUT_FOLDER}/*.STL)

  if(NOT MESH_FILES)
    message(
      WARNING
        "No mesh files (obj, ply, stl, STL) found in folder: ${MESH_INPUT_FOLDER}"
    )
    return()
  endif()
  ...
  foreach(MESH_FILE ${MESH_FILES})
    ...
    add_custom_command(
      ...
      COMMAND ${CMAKE_INSTALL_PREFIX}/bin/mesh_sampling ${MESH_FILE}
              ${SAMPLED_OUTPUT} --type xyz --samples 4000
